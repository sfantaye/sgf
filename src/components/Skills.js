  ...
  return (
    <>
      ...
      >
        ...
        <Skill name='CSS/Sass/Less' x='-5vw' y='-10vw' />
        ...
        <Skill name='Expo' x='-14vw' y='17vw' />
        <Skill name='Bootstrap/Material UI' x='18vw' y='14vw' />
        <Skill name='Amazon Web Services' x='18vw' y='20vw' />
        ...
        <Skill name='Jest' x='40vw' y='-8vw' />
        <Skill name='Redux' x='-16vw' y='4vw' />
        <Skill name='React Test' x='-26vw' y='2vw' />
        <Skill name='Mobile Design' x='-25vw' y='-5vw' />
        <Skill name='Test' x='32vw' y='-14vw' />
